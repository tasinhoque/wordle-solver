...
class WordleHelper:
    def __init__(
        self,
        positionalLetters: list,
        exisitingLetters: str,
        word_length: int,
        possibleLetters: str,
        notPositionalLetters: list,
    ...
    def buildAllWords(self):
        ...
        """
        self.lettersInCorrectPos = "".join(
            letter for letter in self.positionalLetters if letter
        )
        # add already correct letters into consideration to handle duplicates
        self.probableLetters = (
            self.possibleLetters + self.existingLetters + self.lettersInCorrectPos
        )
        # self.__backtrackAllWords(self.word_length, self.myWordAsDict)
...
if __name__ == "__main__":
    ...
    word_length = 5
    possibleLetters = (
        "qwpfgjkzxv"  # all letters - (grey letters + green letters + yellow letters)
    )
